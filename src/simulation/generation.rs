...
use super::cell::{CellPosition, Alive, DeadCellPool, CellSet};
use super::rules::{calculate_neighbor_counts, should_cell_survive, should_cell_be_born};
...
pub fn calculate_next_generation(
    ...
    let alive_positions: FxHashSet<CellPosition> = alive_query.iter()
        .map(|(_, pos)| *pos)
        .collect();
